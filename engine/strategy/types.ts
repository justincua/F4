...
import type { ArbSnapshot, PipelineStageSnapshot } from "../dashboard-state.ts";
...
export type StrategyContext = {
  ...
  /** Push strategy diagnostics to the dashboard without coupling strategy logic to HTML. */
  setDiagnostics: (patch: {
    pipeline?: PipelineStageSnapshot[];
    arb?: Partial<ArbSnapshot>;
  }) => void;
};
